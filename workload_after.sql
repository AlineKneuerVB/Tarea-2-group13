...
-- Consultas después de la materialización de mv_verified_reviews
-- tienen "after" en su etiqueta para diferenciarlas de las originales.
...
FROM mv_verified_reviews
WHERE review_date >= '2026-12-01' AND review_date < '2027-01-01';
...
SELECT DISTINCT user_id, book_id
FROM mv_verified_reviews
WHERE review_date >= '2026-01-01' AND review_date < '2026-02-01';
...
SELECT DISTINCT user_id, book_id
FROM mv_verified_reviews
WHERE review_date >= '2025-03-01' AND review_date < '2025-04-01';
...
SELECT DISTINCT user_id, book_id
FROM mv_verified_reviews
WHERE review_date >= '2025-12-01' AND review_date < '2026-01-01';
...
SELECT DISTINCT user_id, book_id
FROM mv_verified_reviews
WHERE review_date >= '2026-08-01' AND review_date < '2026-09-01';
